...
Spec: docs/superpowers/specs/2026-09-07-phasegrid2-architecture-design.md. Engine rules: docs/engine.md. Protocol: docs/protocol.md. Telemetry: docs/telemetry.md. Workspace and saving: docs/workspace.md.
...
- Settings (including keybindings) live in the workspace's `workspace.json`. Only the dock layout and the workspace pointer live under `userData`.
