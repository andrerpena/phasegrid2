/**
 * Application-level storage: the settings that belong to the installation rather than to a project.
 *
 * Keybindings, the widget layout and the chosen theme live here. A patch, its notes and its assets do
 * not: those belong to the project folder, because a project is a thing you copy to another machine and
 * it has to arrive complete.
 */
...
export const STORAGE_KEYS = ["config", "keybindings", "layout"] as const;
